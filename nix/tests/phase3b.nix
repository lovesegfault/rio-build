...
let
  ...
  # PKI + protoset now live in lib/ (shared with scenarios/security.nix,
  # scenarios/lifecycle.nix). See lib/pki.nix for SAN/CN rationale.
  pki = import ./lib/pki.nix { inherit pkgs; } { };
