...
#
# This file is a testScript FRAGMENT — the assertions are interpolated
# into vm-ingress-v4v6-k3s after its bootstrap so they share that
# scenario's k3s boot instead of paying their own.
{ pkgs }:
''
