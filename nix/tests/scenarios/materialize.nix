...
let
  ...
  routingSubtests = ''
    ...
    # (The walk-unreachability and flag-posture subtest is gone: the
    # walk spawner, its metric, and the coexistence flag were all
    # deleted — criterion 3 is structural.)
  '';
in
