  ...
  fragments = {
    ...
    reconciler-replicas = ''
      ...
      with subtest("reconciler-replicas: SSA field-ownership handoff preserves manual scale"):
          ...
          # ran after our scale.
          k3s_server.wait_until_succeeds(
              "dr=$(k3s kubectl -n ${nsBuilders} get builderpool rio "
    ...
    autoscaler = ''
      ...
      with subtest("autoscaler: queue pressure patches STS replicas 1→2"):
          ...
          # to None every cycle).
          k3s_server.wait_until_succeeds(
              "sc=$(k3s kubectl -n ${nsBuilders} get builderpool rio "
    ...
    finalizer = ''
      ...
      with subtest("finalizer: delete BuilderPool → drain → pod gone → CR gone"):
          ...
          kubectl("delete builderpool rio --wait=false", ns="${nsBuilders}")
          ...
          k3s_server.wait_until_succeeds(
              "! k3s kubectl -n ${nsBuilders} get builderpool rio 2>/dev/null",
              timeout=30,
          )
