...
- *AMI:* the NixOS node AMI (`.#node-ami-<arch>`, #link("decisions/021-nixos-node-ami.md")[ADR-021]). Amazon Linux 2 (AL2, kernel 5.10) does *NOT* support overlayfs-over-FUSE and is not compatible with rio-build executors.
