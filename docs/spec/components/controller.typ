...
#r("ctrl.job.synthesize-on-delete+3")[
  ...
  within a typed freshness bound; a Job whose fresh evidence shows a covering
  open attempt the deciding view did not contain MUST NOT be reaped that
  tick.
]
