...
#table(
  ...
  [4 vCPU, 16 GB, 237 GB NVMe],

  [Instance type (AWS, large builds)],
  [`c6id.2xlarge`],
  [8 vCPU, 16 GB, 474 GB NVMe],
)
...
#table(
  ...
  [Throughput (small builds, \~30s avg)],
  [`executors` × 120/hr],
  [\~120 derivations/hr per executor],

  [Throughput (mixed, \~5min avg)],
  [`executors` × 12/hr],
...
#table(
  ...
  [1 vCPU],
  [1 GB],
  [Scales with concurrent SSH connections (\~1 KB per connection)],
  ...
  [2 vCPU],
  [4 GB],
  [LRU chunk cache: configured via `chunk_cache_capacity_bytes` (default 2 GB)],
