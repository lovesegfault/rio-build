...
| **Controller** | No autoscaling decisions; CRD reconciliation pauses | Pool sizes remain static; no GC scheduling | Restart controller. State is in CRDs and K8s API; no persistent state lost. |
