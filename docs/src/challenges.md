...
> **Scheduled:** `WorkerPoolSet` CRD → [P0232](../.claude/work/plan-0232-wps-crd-struct-crdgen.md) (see [controller.md](components/controller.md#workerpoolset)). Until it lands: multiple independent `WorkerPool` CRs, operator-configured cutoffs in `scheduler.toml`.
