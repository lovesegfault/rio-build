...
|-----------|-------------|
| `gc_retention_hours` | Minimum retention for completed build outputs (default 168 = 7 days) |
| `gc_max_store_bytes` | Maximum total store size for the tenant (`NULL` = unlimited) |
