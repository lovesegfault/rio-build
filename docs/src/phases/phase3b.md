...
- [ ] TriggerGC RPC wiring — store has mark+sweep+drain, scheduler has GcRoots command; the AdminService.TriggerGC → store RPC proxy + gRPC admin service on store needs Phase 4 proto additions
