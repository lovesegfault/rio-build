...
- ~~**Inline fast-path**: NARs below 256KB stored as a single blob in PostgreSQL.~~ **Superseded — removed in [ADR-022](./022-design-overview.md) §10.** All NARs are chunked; durability for tiny paths is the binary-cache compat layer's job.
