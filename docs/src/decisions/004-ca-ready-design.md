...
- CA cutoff-compare is implemented (P0251); propagate + DAG cascade is P0252; CA derivation resolution (rewriting `inputDrvs` to replace placeholder output paths with realized paths) is P0253.
