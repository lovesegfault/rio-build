...
**Crate:** `rio-builder, infra` · **Deps:** P0576, P0578 · **Complexity:** MED (~250 LoC + helm) · **Status:** PARTIAL 2026-05-21 (daemon + wire protocol + unit tests + `vm-mountd` VM test; helm DS, eks-node XFS assert pending)
