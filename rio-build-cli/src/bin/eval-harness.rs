//! Coordinator-side test harness for the rio-eval parent (ADR-024
//! P3b). Speaks the REAL worker channel (spawn with fd 3, send
...
async fn main() -> anyhow::Result<()> {
    ...
    let (chan, mut child) = evalchan::spawn_eval_parent(&args.eval_parent, &parent_args)
