...
```markdown
| `rio_worker_bloom_fill_ratio >= 0.5` | Worker FUSE cache bloom filter saturated — FPR climbing past 1%. Bump `spec.bloomExpectedItems` on the WorkerPool and restart. | [P998902142](../.claude/work/plan-998902142-bloom-expected-items-crd-knob.md) |
```
