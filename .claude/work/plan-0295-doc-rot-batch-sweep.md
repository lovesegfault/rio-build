...
### T989733312 — `docs(test):` test_scripts.py:1506 — "realistic" → "plausible — P0430 log not retained"
...
- T989733312: `grep 'realistic nix-level' .claude/lib/test_scripts.py` → 0 hits; `grep 'Plausible.*plan-prescribed\|NOT corpus-verified' .claude/lib/test_scripts.py` → ≥1 hit
...
[
  ...
  {"path": ".claude/lib/test_scripts.py", "action": "MODIFY", "note": "T989733312: :1506 realistic→plausible — distinguishes plan-prescribed from corpus-verified. Adjacent to P989733302 T2's insertions at :1508. discovered_from=447"}
]
```
