...
async fn cascade_only_skips_verified_candidates() {
    ...
    //           [P995943541 makes C go Ready instead of stuck-Queued.]
    //
...
~30 lines. Partners with [P995943541](plan-995943541-all-deps-completed-skipped-hang.md)-T3 (that test asserts C goes Ready; this test asserts C does NOT go Skipped — complementary assertions on the same scenario). discovered_from=252. **Post-P0252-merge** (DONE).
...
**Post-P0280-merge.** discovered_from=280. Soft-dep [P995943542](plan-995943542-graph-page-skipped-worker-race.md) (that plan's inflight-gate fix changes the `layoutInWorker` calling code; T69's tests should reflect the post-fix shape).
