...
[
  ...
  {"path": "rio-store/tests/metrics_registered.rs", "action": "MODIFY", "note": "T33: +all_histograms_have_bucket_config test (exempt put_path_duration_seconds); r[verify obs.metric.store]"},
  {"path": "rio-gateway/tests/metrics_registered.rs", "action": "MODIFY", "note": "T33: +all_histograms_have_bucket_config test (exempt opcode_duration_seconds); r[verify obs.metric.gateway]"},
