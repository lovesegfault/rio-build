...
[
  ...
  {"path": ".claude/notes/bughunter-log.md", "action": "MODIFY", "note": "T162: +mc196 entry — self-match FINDING (→P0397) + smell counts"}
]
```
