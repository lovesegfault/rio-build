...
### T989430201 — `docs(scheduler):` test_inject_ready docstring — enumerate stubs
...
- T989430201: `grep -c 'Stubbed\|required_features = \[\]\|from_recovery_row.*inherent' rio-scheduler/src/actor/mod.rs` ≥ 3 (docstring enumerates stubs + names the inherent-loss mechanism)
...
[
  ...
  {"path": "rio-scheduler/src/actor/mod.rs", "action": "MODIFY", "note": "T989430201: test_inject_ready docstring at :1217 — enumerate stubs (required_features/expected_output_paths/output_names/is_ca/is_fixed_output + from_recovery_row inherent losses). HOT count=37 — doc-comment-only. discovered_from=501"}
]
```
