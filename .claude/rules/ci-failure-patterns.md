...
| **Coverage profraw timeout** | `.#coverage` or `cov-vm-*` hits `globalTimeout` | Coverage-mode k3s tests have builder-disk I/O variance. Bump `globalTimeout` with headroom. Check if tmpfs is wired for the containerd store. |
