...
class PlanFile(BaseModel):
    ...
    path: str = Field(
        pattern=r"^(rio-[a-z-]+/|xtask/|nix/|docs/|infra/|migrations/|workspace-hack/|scripts/|flake\.nix|flake\.lock|\.claude/|\.cargo/|Cargo|\.config/|\.github/|\.envrc|codecov\.yml|deny\.toml|justfile|[A-Z]+\.md$)"
    )
