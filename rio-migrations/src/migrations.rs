...
// BURNED NUMBERS — 065 through 070 (next free migration: 071):
//
// - 065–068 are allocated by the integration branch's castore
//   migrations (nar_index, file_blob_size, directory_paths,
//   drop_nar_indexed) per the numbering policy above — the deployed
//   lineage owns the numbers.
