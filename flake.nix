        ...
        config = {
          ...
          perSystem =
            ...
            let
              ...
              # over its 1-line stub is a no-op. Passed to checks.nix so
              # the filter has one definition.
              ...
              covExtractPatterns = pkgs.lib.mapAttrsToList (n: _: "${n}/*") (noHack memberFilesets);
              ...
              crateChecks =
                ...
                import ./nix/checks.nix {
                  ...
                  # bin-only `memberSrcs` above that feeds crate2nix; this
                  # is the only variant that needs tests/ at runtime.
