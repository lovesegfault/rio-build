      ...
      { withSystem, flake-parts-lib, ... }:
      {
        ...
        options.perSystem = flake-parts-lib.mkPerSystemOption {
          options.ciMatrix = nixpkgs.lib.mkOption {
            ...
            description = "GHA matrix data: {checks, formal, fuzz, vm-test, vm-test-slow, coverage} → name→drv attrsets";
          };
        };
          ...
          perSystem =
            ...
            let
              ...
              ciMatrix = {
                ...
                # layer) so `nix-fast-build .#checks` and `nix build
                # .#ci.vm-test` are unchanged. The vm-test-slow GHA job
