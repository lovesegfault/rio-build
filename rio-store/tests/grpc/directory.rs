//! ADR-022 castore RPC surface integration tests (P0573).
//!
...
//! drives `GetDirectory` / `HasDirectories` / `HasBlobs` end-to-end.
...
use rio_proto::types::{
    GetDirectoryRequest, HasBlobsRequest, HasDirectoriesRequest, get_directory_request,
};
