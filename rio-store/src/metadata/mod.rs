...
pub(crate) use chunked::{
    chunk_lists_for_paths, clear_chunk_presence, commit_chunked_output_in_conn,
    complete_manifest_chunked, insert_path_tenant_in_conn,
...
pub(crate) async fn complete_manifest_in_conn(
    ...
    // — presence is tenant-scoped; this is the single
