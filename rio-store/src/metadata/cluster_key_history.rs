...
mod tests {
    ...
    async fn load_prior_cluster_skips_malformed_warns_loudly() {
        ...
        let v1 = Signer::from_seed("cache-v1", &[0xAA; 32])
            .unwrap()
            .trusted_key_entry();
        let v2 = Signer::from_seed("cache-v2", &[0xBB; 32])
            .unwrap()
            .trusted_key_entry();
    ...
    async fn load_prior_cluster_all_valid_no_warn() {
        ...
        let v1 = Signer::from_seed("clean-v1", &[0xCC; 32])
            .unwrap()
            .trusted_key_entry();
    ...
    async fn load_prior_cluster_warns_on_name_collision() {
        ...
        let prior = Signer::from_seed("rio-prod", &[0xDD; 32])
            .unwrap()
            .trusted_key_entry();
        sqlx::query("INSERT INTO cluster_key_history (pubkey) VALUES ($1)")
            .bind(&prior)
