...
2026-05-26 design spike that preceded the rio-parity implementation. The
...
`rio-parity/src/evalset/depclosure.rs` assert the literal store paths.
...
- Update the literal store paths asserted in
  `rio-parity/src/evalset/depclosure.rs` to match, and note the
