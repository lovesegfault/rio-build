...
pub fn selection_expr(
    ...
    writeln!(
        expr,
        "# Generated by rio-replay eval: scoped selection over the Hydra jobset entry point."
    )?;
    writeln!(expr, "let")?;
...
mod tests {
    ...
    fn selection_expression_golden() {
        ...
        .unwrap();
        let expected = r#"# Generated by rio-replay eval: scoped selection over the Hydra jobset entry point.
let
