...
impl SchedulerDb {
    ...
    /// `is_root` (migration 065, demand-set semantics per the M_065
    /// doc-const) re-derives `BuildInfo::root_hashes` so the force-build
    /// substitution gates survive failover.
