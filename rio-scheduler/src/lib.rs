...
pub fn describe_metrics() {
    ...
    describe_counter!(
        ...
        "Worker-reported sizing claims refused by the corroboration gate \
         ...
         persisted floors never move (every floor mutation demands a typed \
         CorroborationWitness; the caller alphabet stays census-pinned, \
         bump_resource_floor_caller_census). Alert if rate > 0: a forged or \
